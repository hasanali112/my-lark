...
const Footer = () => {
  return (
    <footer className="relative z-10 pt-32 pb-12 px-6 border-t border-[#DEE0E3] bg-[#F5F6F7]/30">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="col-span-1 md:col-span-1">
          <div className="flex items-center space-x-2 mb-6">
            ...
            <span className="text-xl font-bold tracking-tight text-[#1F2329]">UrbanSync</span>
          </div>
          <p className="text-[#646A73] text-sm leading-relaxed max-w-xs">
            Pioneering the future of urban infrastructure through intelligent, data-driven synchronization.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-[#646A73]">
            ...
            <li><Link href="#" className="hover:text-primary transition-colors">Case City</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-[#646A73]">
            ...
            <li><Link href="#" className="hover:text-primary transition-colors">Press Room</Link></li>
        ...
        <div>
          ...
          <p className="text-sm text-[#646A73] mb-4">Stay synchronized with the latest urban tech.</p>
          <div className="flex">
            <input 
              type="text" 
      ...
      <div className="max-w-7xl mx-auto mt-24 pt-8 border-t border-[#DEE0E3] flex flex-col md:flex-row justify-between items-center text-xs text-[#646A73]/70 space-y-4 md:space-y-0">
